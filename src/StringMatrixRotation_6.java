...
public class StringMatrixRotation_6 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (input.length() > maxWords) {
                maxWords = input.length();
            }
        }
        ...
        rotateMatrix(angleRotation, rows, cols, matrix);
    }

    private static void rotateMatrix(int angleRotation, int rows, int cols, char[][] matrix) {
        if (angleRotation == 90) {
            for (int col = 0; col < cols; col++) {
